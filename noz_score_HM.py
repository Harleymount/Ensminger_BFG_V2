...
if __name__ == "__main__":
    # test on yAD4 DB1
    test_dir = "/Users/harleymount/Desktop/score_test"
...
#call get_rank_final with max_rank[-1]
#get_rank_final(norm_s, max_rank[-1])

    mcc_summary, s, norm_score= main_final(plus_his, minus_his, gold_st)

    norm_score[[max_rank][0]].to_csv('normalized_score_optimal_nozomu.csv', index=False)

#----------will write code below here to run scoring using just optimal condition 