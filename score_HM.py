...
#j='is_0' # for troubleshooting for loop below
    for j in dicts.keys():
        i = dicts[j]
...
if __name__ == "__main__":
    ...
    counts = '/Users/harleymount/Desktop/score_test/'#put absolute path to counts here
    ...
    yi = load_YI1(param.GOLD)#load the gold standard # should be stored in BFG/summary
...
#----------------evaluate using DK method

    # evaluation
    litbm = load_litbm(param.litBM13)
    dk_main(litbm, max_weight, max_rank, max_floor, minus_his_freq, row_freq, col_freq, AD_NAMES, DB_NAMES, "dk_mcc_summary_litbm13")
